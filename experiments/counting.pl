all([
	...
	[cartde, cartflash, lp4ee],
	[cartflash, cartde],
	[lp4ee, cartflash, abende, abe0, cartde],
	[cartflash, cartde],
	[cartflash],
	[cartde, cartflash, atlm],
	[cartde],
	[lp4ee, abende, abe0, cartflash],
	[cartflash, lp4ee, cartde],
	[cartflash, cartde, lp4ee, atlm]
	]).
